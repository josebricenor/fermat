...
public enum Plugins implements FermatPluginsEnum {
    ...
    DIGITAL_ASSET("DIA"),
    ASSET_SINGLE_TRANSACTION_ISSUING("ASTI"),
    DESKTOP_RUNTIME             ("DER"),
    DEVELOPER                   ("DEV"),
    DEVICE_USER                 ("DU"),
    ...
    INCOMING_ASSET_OFFER        ("IAO"),
    OUTGOING_ASSET_OFFER        ("OAO"),
    INCOMING_ASSET_METADATA     ("IAM"),
    OUTGOING_ASSET_METADATA     ("OAM"),
    INTRA_IDENTITY_USER         ("IIA"),
    INTRA_WALLET_USER           ("IWU"),
    ISSUER_REDEMPTION           ("IR"),
    ISSUER_APPROPRIATION        ("ISAP"),
    MULTI_TRANSACTION_ASSET_ISSUING ("MTASI"),
    NOTIFICATION                ("NOT"),
