package org.fermat.fermat_dap_plugin.layer.crypto_transaction.asset_outgoing.developer.version_1.structure.events;
 ...
 */
public class AssetOutgoingRecorderService implements AssetTransactionService {
    ...
    private final AssetOutgoingDAO dao;
    ...
    public AssetOutgoingRecorderService(EventManager eventManager, UUID pluginId, AssetOutgoingDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new AssetOutgoingEventHandler(this);
        } catch (Exception e) {
