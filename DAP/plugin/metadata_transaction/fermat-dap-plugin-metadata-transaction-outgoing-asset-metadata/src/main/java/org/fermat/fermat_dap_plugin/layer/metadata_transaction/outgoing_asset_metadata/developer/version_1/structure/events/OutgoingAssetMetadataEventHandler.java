 ...
 */
public class OutgoingAssetMetadataEventHandler implements FermatEventHandler {
    ...
    public OutgoingAssetMetadataEventHandler(OutgoingAssetMetadataRecorderService recorderService) {
