...
public class IncomingAssetMetadataDeveloperDatabaseFactory {
    ...
    public void initializeDatabase() throws CantInitializeAssetRedeemPointRedemptionTransactionDatabaseException {
        try {
            ...
            throw new CantInitializeAssetRedeemPointRedemptionTransactionDatabaseException(cantOpenDatabaseException.getMessage());
              ...
              */
            IncomingAssetMetadataDatabaseFactory assetAppropriationDatabaseFactory = new IncomingAssetMetadataDatabaseFactory(pluginDatabaseSystem, pluginId);
    ...
    public static List<DeveloperDatabaseTable> getDatabaseTableList(DeveloperObjectFactory developerObjectFactory) {
        ...
        incomingAssetMetadataColumns.add(IncomingAssetMetadataDatabaseConstants.INCOMING_ASSET_METADATA_COLUMN_NAME);

        DeveloperDatabaseTable incomingAssetMetadataTable = developerObjectFactory.getNewDeveloperDatabaseTable(IncomingAssetMetadataDatabaseConstants.INCOMING_ASSET_METADATA_TABLE, incomingAssetMetadataColumns);
