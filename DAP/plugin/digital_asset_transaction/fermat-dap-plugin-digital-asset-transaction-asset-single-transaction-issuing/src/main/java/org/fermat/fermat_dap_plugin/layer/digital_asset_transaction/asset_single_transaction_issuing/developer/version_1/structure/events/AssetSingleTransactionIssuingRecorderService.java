 ...
 */
public class AssetSingleTransactionIssuingRecorderService implements AssetTransactionService {
    ...
    public AssetSingleTransactionIssuingRecorderService(EventManager eventManager, UUID pluginId, AssetSingleTransactionIssuingDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new AssetSingleTransactionIssuingEventHandler(this);
        } catch (Exception e) {
