 ...
 */
public class MultiTransactionAssetIssuingRecorderService implements AssetTransactionService {
    ...
    public MultiTransactionAssetIssuingRecorderService(EventManager eventManager, UUID pluginId, MultiTransactionAssetIssuingDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new MultiTransactionAssetIssuingEventHandler(this);
        } catch (Exception e) {
