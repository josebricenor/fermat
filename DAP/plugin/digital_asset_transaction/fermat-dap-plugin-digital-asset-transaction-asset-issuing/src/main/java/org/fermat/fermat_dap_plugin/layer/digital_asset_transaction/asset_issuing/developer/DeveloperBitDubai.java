package org.fermat.fermat_dap_plugin.layer.digital_asset_transaction.asset_issuing.developer;
...
public class DeveloperBitDubai extends AbstractPluginDeveloper implements PluginLicensor {
    ...
    public void start() throws CantStartPluginDeveloperException {
        try {
            ...
            this.registerVersion(new AssetIssuingDigitalAssetTransactionPluginRoot());
            System.out.println("LFLT: REGISTRED DAT ASSET ISSUING");
