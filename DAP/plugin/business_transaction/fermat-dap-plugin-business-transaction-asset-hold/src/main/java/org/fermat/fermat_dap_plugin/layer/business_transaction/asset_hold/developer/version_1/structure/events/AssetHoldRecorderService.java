 ...
 */
public class AssetHoldRecorderService implements AssetTransactionService {
    ...
    public AssetHoldRecorderService(EventManager eventManager, UUID pluginId, AssetHoldDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new AssetHoldEventHandler(this);
        } catch (Exception e) {
