 ...
 */
public class AssetUnholdRecorderService implements AssetTransactionService {
    ...
    public AssetUnholdRecorderService(EventManager eventManager, UUID pluginId, AssetUnholdDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new AssetUnholdEventHandler(this);
        } catch (Exception e) {
