 ...
 */
public class AssetTransferMonitorAgent extends FermatAgent {
    ...
    public AssetTransferMonitorAgent(ErrorManager errorManager, AssetTransferDAO dao) {
    ...
    private class BuyerAgent implements Runnable {
        ...
        public void run() {
            try {
                ...
                errorManager.reportUnexpectedPluginException(Plugins.ASSET_TRANSFER_STATISTIC, UnexpectedPluginExceptionSeverity.DISABLES_SOME_FUNCTIONALITY_WITHIN_THIS_PLUGIN, e);
            }
        }
