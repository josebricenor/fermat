package org.fermat.fermat_dap_plugin.layer.statistic_collector.asset_transfer.developer.version_1;
...
import org.fermat.fermat_dap_plugin.layer.statistic_collector.asset_transfer.developer.version_1.developer_utils.AssetTransferDeveloperDatabaseFactory;
...
import org.fermat.fermat_dap_plugin.layer.statistic_collector.asset_transfer.developer.version_1.structure.database.AssetTransferDatabaseFactory;
import org.fermat.fermat_dap_plugin.layer.statistic_collector.asset_transfer.developer.version_1.structure.events.AssetTransferMonitorAgent;
import org.fermat.fermat_dap_plugin.layer.statistic_collector.asset_transfer.developer.version_1.structure.events.AssetTransferRecorderService;
...
public class AssetTransferPluginRoot extends AbstractPlugin implements
    ...
    private AssetTransferMonitorAgent agent;
    ...
    public void start() throws CantStartPluginException {
        try {
            ...
            agent = new AssetTransferMonitorAgent(errorManager, dao);
    ...
    public List<DeveloperDatabaseTableRecord> getDatabaseTableContent(DeveloperObjectFactory developerObjectFactory, DeveloperDatabase developerDatabase, DeveloperDatabaseTable developerDatabaseTable) {
        ...
        try {
            ...
            this.errorManager.reportUnexpectedPluginException(Plugins.ASSET_TRANSFER_STATISTIC, UnexpectedPluginExceptionSeverity.DISABLES_SOME_FUNCTIONALITY_WITHIN_THIS_PLUGIN, e);
