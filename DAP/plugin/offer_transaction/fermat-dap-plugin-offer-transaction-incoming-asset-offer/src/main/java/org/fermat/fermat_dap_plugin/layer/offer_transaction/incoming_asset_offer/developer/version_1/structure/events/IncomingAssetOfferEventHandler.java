 ...
 */
public class IncomingAssetOfferEventHandler implements FermatEventHandler {
    ...
    public IncomingAssetOfferEventHandler(IncomingAssetOfferRecorderService recorderService) {
