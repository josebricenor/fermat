 ...
 */
public class IncomingAssetOfferRecorderService implements AssetTransactionService {
    ...
    public IncomingAssetOfferRecorderService(EventManager eventManager, UUID pluginId, IncomingAssetOfferDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new IncomingAssetOfferEventHandler(this);
        } catch (Exception e) {
