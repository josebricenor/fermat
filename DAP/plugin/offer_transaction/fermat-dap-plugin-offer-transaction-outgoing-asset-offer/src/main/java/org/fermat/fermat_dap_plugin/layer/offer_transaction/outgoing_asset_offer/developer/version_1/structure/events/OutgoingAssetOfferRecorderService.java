 ...
 */
public class OutgoingAssetOfferRecorderService implements AssetTransactionService {
    ...
    public OutgoingAssetOfferRecorderService(EventManager eventManager, UUID pluginId, OutgoingAssetOfferDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new OutgoingAssetOfferEventHandler(this);
        } catch (Exception e) {
