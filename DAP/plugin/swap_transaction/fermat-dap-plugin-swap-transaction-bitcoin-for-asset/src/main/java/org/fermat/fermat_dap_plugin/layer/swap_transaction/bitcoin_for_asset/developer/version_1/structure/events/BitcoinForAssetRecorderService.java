 ...
 */
public class BitcoinForAssetRecorderService implements AssetTransactionService {
    ...
    public BitcoinForAssetRecorderService(EventManager eventManager, UUID pluginId, BitcoinForAssetDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new BitcoinForAssetEventHandler(this);
        } catch (Exception e) {
