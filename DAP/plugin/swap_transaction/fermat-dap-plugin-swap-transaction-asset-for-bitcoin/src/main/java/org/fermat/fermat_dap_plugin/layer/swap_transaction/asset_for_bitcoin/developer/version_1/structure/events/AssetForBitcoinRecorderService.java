 ...
 */
public class AssetForBitcoinRecorderService implements AssetTransactionService {
    ...
    public AssetForBitcoinRecorderService(EventManager eventManager, UUID pluginId, AssetForBitcoinDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new AssetForBitcoinEventHandler(this);
        } catch (Exception e) {
