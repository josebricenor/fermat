 ...
 */
public class AssetMinerRecorderService implements AssetTransactionService {
    ...
    public AssetMinerRecorderService(EventManager eventManager, UUID pluginId, AssetMinerDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new AssetMinerEventHandler(this);
        } catch (Exception e) {
