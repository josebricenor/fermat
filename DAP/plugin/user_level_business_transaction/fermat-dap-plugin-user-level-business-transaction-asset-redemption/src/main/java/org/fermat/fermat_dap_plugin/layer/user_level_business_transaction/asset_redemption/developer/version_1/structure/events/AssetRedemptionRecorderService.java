...
import org.fermat.fermat_dap_plugin.layer.user_level_business_transaction.asset_redemption.developer.version_1.structure.database.AssetRedemptionDAO;
 ...
 */
public class AssetRedemptionRecorderService implements AssetTransactionService {
    ...
    private final AssetRedemptionDAO dao;
    ...
    public AssetRedemptionRecorderService(EventManager eventManager, UUID pluginId, AssetRedemptionDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new AssetRedemptionEventHandler(this);
        } catch (Exception e) {
