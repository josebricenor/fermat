 ...
 */
public class AssetRedemptionEventHandler implements FermatEventHandler {

    //VARIABLE DECLARATION
    private AssetRedemptionRecorderService recorderService;

    //CONSTRUCTORS

    public AssetRedemptionEventHandler(AssetRedemptionRecorderService recorderService) {
