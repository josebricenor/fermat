...
public final class AssetTransferDatabaseFactory {
    ...
    public Database createDatabase() throws CantCreateDatabaseException {
        ...
        try {
            ...
            digitalAssetMetadataTable.addColumn(AssetTransferDatabaseConstants.ASSET_TRANSFER_ID_COLUMN_NAME, DatabaseDataType.STRING, 100, Boolean.TRUE);

            digitalAssetMetadataTable.addIndex(AssetTransferDatabaseConstants.ASSET_TRANSFER_ID_COLUMN_NAME);
            try {
                //Create the table
