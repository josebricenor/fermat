 ...
 */
public class AssetFixedBitcoinPriceDirectPrivateSellRecorderService implements AssetTransactionService {
    ...
    public AssetFixedBitcoinPriceDirectPrivateSellRecorderService(EventManager eventManager, UUID pluginId, AssetFixedBitcoinPriceDirectPrivateSellDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new AssetFixedBitcoinPriceDirectPrivateSellEventHandler(this);
        } catch (Exception e) {
