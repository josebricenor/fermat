 ...
 */
public class AssetDistributionRecorderService implements AssetTransactionService {
    ...
    private final org.fermat.fermat_dap_plugin.layer.user_level_business_transaction.asset_distribution.developer.version_1.structure.database.AssetDistributionDAO dao;
    ...
    public AssetDistributionRecorderService(EventManager eventManager, UUID pluginId, org.fermat.fermat_dap_plugin.layer.user_level_business_transaction.asset_distribution.developer.version_1.structure.database.AssetDistributionDAO dao) {
