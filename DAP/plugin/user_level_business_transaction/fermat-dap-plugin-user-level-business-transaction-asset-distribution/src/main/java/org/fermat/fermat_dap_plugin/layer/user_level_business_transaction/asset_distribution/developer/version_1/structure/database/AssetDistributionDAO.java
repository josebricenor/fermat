...
public class AssetDistributionDAO {
    ...
    //CONSTRUCTORS
    public AssetDistributionDAO(UUID pluginId, PluginDatabaseSystem pluginDatabaseSystem) throws CantExecuteDatabaseOperationException {
    ...
    public void saveNewEvent(FermatEvent event) throws CantSaveEventException {
        ...
        try {
            ...
            eventRecord.setLongValue(AssetDistributionDatabaseConstants.ASSET_DISTRIBUTION_EVENTS_RECORDED_TIMESTAMP_COLUMN_NAME, System.currentTimeMillis());
    ...
    private DatabaseTable getAssetDistributionTable() {
        return database.getTable(AssetDistributionDatabaseConstants.ASSET_DISTRIBUTION_TABLE);
    }
