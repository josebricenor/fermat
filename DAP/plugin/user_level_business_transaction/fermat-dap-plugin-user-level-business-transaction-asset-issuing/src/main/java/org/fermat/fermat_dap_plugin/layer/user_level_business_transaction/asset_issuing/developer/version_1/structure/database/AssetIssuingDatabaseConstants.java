...
public class AssetIssuingDatabaseConstants {
    //DATABASE
    public static final String ASSET_ISSUING_DATABASE = "asset_issuing_database";

    //ASSET ISSUING TABLE
    public static final String ASSET_ISSUING_TABLE = "asset_issuing";
    public static final String ASSET_ISSUING_ID_COLUMN_NAME = "id";

    //EVENTS RECORDED TABLE
    public static final String ASSET_ISSUING_EVENTS_RECORDED_TABLE_NAME = "events_recorded";
    ...
    public static final String ASSET_ISSUING_EVENTS_RECORDED_TABLE_FIRST_KEY_COLUMN = ASSET_ISSUING_EVENTS_RECORDED_ID_COLUMN_NAME;
}
