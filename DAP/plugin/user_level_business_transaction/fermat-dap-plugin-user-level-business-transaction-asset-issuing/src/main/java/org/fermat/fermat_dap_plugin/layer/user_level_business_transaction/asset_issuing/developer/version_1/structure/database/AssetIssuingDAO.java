...
public class AssetIssuingDAO {
    ...
    //CONSTRUCTORS
    public AssetIssuingDAO(UUID pluginId, PluginDatabaseSystem pluginDatabaseSystem) throws CantExecuteDatabaseOperationException {
    ...
    private DatabaseTable getAssetIssuingTable() {
        return database.getTable(AssetIssuingDatabaseConstants.ASSET_ISSUING_TABLE);
    }
