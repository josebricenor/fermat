 ...
 */
public class AssetBreakRecorderService implements AssetTransactionService {
    ...
    public AssetBreakRecorderService(EventManager eventManager, UUID pluginId, AssetBreakDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new AssetBreakEventHandler(this);
        } catch (Exception e) {
