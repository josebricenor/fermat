 ...
 */
public class AssetIssuerRecorderService implements AssetTransactionService {
    ...
    public AssetIssuerRecorderService(EventManager eventManager, UUID pluginId, AssetIssuerDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new AssetIssuerEventHandler(this);
        } catch (Exception e) {
