 ...
 */
public class AssetIssuerMonitorAgent extends FermatAgent {
    ...
    private class BuyerAgent implements Runnable {
        ...
        public void run() {
            try {
                ...
                errorManager.reportUnexpectedPluginException(Plugins.ASSET_ISSUER_STATISTIC, UnexpectedPluginExceptionSeverity.DISABLES_SOME_FUNCTIONALITY_WITHIN_THIS_PLUGIN, e);
            }
        }
