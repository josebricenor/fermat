package org.fermat.fermat_dap_plugin.layer.actor_connection.redeem_point.developer.version_1.structure.events;
 ...
 */
public class AssetIncomingRecorderService implements AssetTransactionService {
    ...
    private final AssetIncomingDAO dao;
    ...
    public AssetIncomingRecorderService(EventManager eventManager, UUID pluginId, AssetIncomingDAO dao) {
    ...
    public void start() throws CantStartServiceException {
        ...
        try {
            ...
            FermatEventHandler fermatEventHandler = new AssetIncomingEventHandler(this);
        } catch (Exception e) {
